...
Central location for all SEO keywords, organized by page and keyword type.
...
### Location-Based
- Coffee shop District 1 HCMC
- Coffee roastery Ho Chi Minh City
- Specialty coffee Saigon
- Premium coffee Vietnam

### Neighborhood
- Coffee Phú Thọ Hòa
- HCMC coffee shop local
- Vietnamese coffee specialty
...
- Aim for 0.5-3% keyword density
- Spread keywords naturally throughout content
- Use in titles, headings, meta descriptions
...
5. **Image Alt Text**
   - Descriptive with keyword where relevant
   - Never keyword stuff
...
For detailed implementation, see README.md → "SEO & Keywords" section.
